...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Índice Fórum</a> &gt; Lista de mensagens Pessoais
    </div>
	<div class="box_right">
...
Esta é a lista de suas mensagens pessoais:<br /><br>
<a href="new_pm.php" class="button">Enviar mensagem</a><br /><br>
<h3>Mensagens não lidas(<?php echo intval(mysql_num_rows($req1)); ?>):</h3>
<table class="list_pm">
	<tr>
    	<th class="title_cell">Título</th>
        <th>Núm de respostas</th>
        <th>Participante</th>
        <th>Data envio</th>
    </tr>
<?php
...
?>
	<tr>
    	<td colspan="4" class="center">Não há mensagens não lidas.</td>
    </tr>
<?php
}
?>
...
<br />
<h3>Mensagens lidas(<?php echo intval(mysql_num_rows($req2)); ?>):</h3>
<table class="list_pm">
	<tr>
    	<th class="title_cell">Título</th>
        <th>Núm de Respostas</th>
...
?>
	<tr>
    	<td colspan="4" class="center">Não há mensagens lidas.</td>
    </tr>
<?php
}
?>
