...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Índice Fórum</a> &gt; <a href="list_topics.php?parent=<?php echo $dn1['parent']; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; <a href="read_topic.php?id=<?php echo $id; ?>"><?php echo htmlentities($dn1['title'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; Ler Tópico
    </div>
	<div class="box_right">
...
{
?>
	<a href="new_reply.php?id=<?php echo $id; ?>" class="button">Responder</a>
<?php
}
...
{
	echo '<h2>O tópico não existe.</h2>';
}
}
else
{
	echo '<h2>Identificação não confirmada.</h2>';
}
?>
