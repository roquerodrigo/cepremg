...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Índice Fórum</a> &gt; <a href="list_topics.php?parent=<?php echo $id; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a>
    </div>
	<div class="box_right">
...
{
?>
	<a href="new_topic.php?parent=<?php echo $id; ?>" class="button">Novo Tópico</a>
<?php
}
...
{
?>
<div class="message">Não há tópicos nesta categoria.</div>
<?php
}
if(isset($_SESSION['username']))
{
...
{
	echo '<h2>Categoria inexistente.</h2>';
}
}
else
{
	echo '<h2>Identificação não confirmada para acesso a página.</h2>';
}
?>
