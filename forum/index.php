...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Índice Fórum</a>
    </div>
	<div class="box_right">
...
{
?>
	<a href="new_category.php" class="button">Nova categoria</a>
<?php
}
?>
<table class="categories_table">
	<tr>
    	<th class="forum_cat">Categoria</th>
    	<th class="forum_ntop">Tópicos</th>
    	<th class="forum_nrep">Respostas</th>
<?php
if(isset($_SESSION['username']) and $_SESSION['username']==$admin)
{
?>
    	<th class="forum_act">Ação</th>
<?php
}
?>
	</tr>
...
{
?>
    	<td><a href="delete_category.php?id=<?php echo $dnn1['id']; ?>"><img src="<?php echo $design; ?>/images/delete.png" alt="Deletar" height="12" width="12"/></a>
		<?php if($dnn1['position']>1){ ?><a href="move_category.php?action=up&id=<?php echo $dnn1['id']; ?>"><img src="<?php echo $design; ?>/images/up.png" alt="Mover para cima" height="12" width="12" /></a><?php } ?>
		<?php if($dnn1['position']<$nb_cats){ ?><a href="move_category.php?action=down&id=<?php echo $dnn1['id']; ?>"><img src="<?php echo $design; ?>/images/down.png" alt="Mover para baixo" height="12" width="12" /></a><?php } ?>
		<a href="edit_category.php?id=<?php echo $dnn1['id']; ?>"><img src="<?php echo $design; ?>/images/edit.png" alt="Editar" height="12" width="12"/></a></td>
<?php
}
?>
    </tr>
...
<div class="box_login">
	<form action="login.php" method="post">
		<label for="username">Usuário</label><input type="text" name="username" id="username" /><br />
        ...
        <div class="center">
	        <input type="submit" value="Login" /> <input type="button" onclick="javascript:document.location='signup.php';" value="Cadastrar" />
        </div>
    </form>
</div>
<?php
