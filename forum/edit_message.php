...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Índice fórum</a> &gt; <a href="list_topics.php?parent=<?php echo $dn1['parent']; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; <a href="read_topic.php?id=<?php echo $id; ?>"><?php echo htmlentities($dn1['title'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; Editar resposta
    </div>
	<div class="box_right">
...
if(isset($_POST['message']) and $_POST['message']!='')
{
	...
	{
	?>
	<div class="message">Mensagem editada com sucesso!<br />
	<a href="read_topic.php?id=<?php echo $id; ?>">Ir para o tópico</a></div>
	<?php
	}
	else
	{
		echo 'Erro ao editar mensagem.';
	}
}
else
{
...
{
?>
	<label for="title">Assunto</label><input type="text" name="title" id="title" value="<?php echo htmlentities($dn1['title'], ENT_QUOTES, 'UTF-8'); ?>" />
<?php
}
?>
...
{
	echo '<h2>Você não tem permissão para editar esta mensagem.</h2>';
}
}
else
{
	echo '<h2>Mensagem não existe..</h2>';
}
}
else
{
?>
<h2>Você precisa estar logado para acessar a página:</h2>
<div class="box_login">
...
{
	echo '<h2>Mensagem não identificada.</h2>';
}
?>
