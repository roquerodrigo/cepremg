...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Índice Fórum</a> &gt; Editar Perfil
    </div>
	<div class="box_right">
...
?>
<div class="message">Perfil editado com sucesso, logar novamente.<br />
...
?>
    <form action="edit_profile.php" method="post">
        ...
        <div class="center">
            <label for="username">Usuário</label><input type="text" name="username" id="username" value="<?php echo $username; ?>" /><br />
            <label for="password">Senha<span class="small">(mínimo 6 caracteres)</span></label><input type="password" name="password" id="password" value="<?php echo $password; ?>" /><br />
            <label for="passverif">Senha<span class="small">(confirmar)</span></label><input type="password" name="passverif" id="passverif" value="<?php echo $password; ?>" /><br />
            <label for="email">Email</label><input type="text" name="email" id="email" value="<?php echo $email; ?>" /><br />
            <label for="avatar">Foto<span class="small">(opcional)</span></label><input type="text" name="avatar" id="avatar" value="<?php echo $avatar; ?>" /><br />
