	...
	if($_POST['title']!='' and $_POST['recip']!='' and $_POST['message']!='')
	{
		...
		if($dn1['recip']==1)
		{
			if($dn1['recipid']!=$_SESSION['userid'])
			{
				...
				{
	?>
	<div class="message">Mensagem enviada com sucesso.<br />
	<a href="list_pm.php">Lista de mensagens</a></div>
	<?php
					$form = false;
				}
				else
		...
		{
			$error = 'Usuário destino não existe.';
		}
	}
	else
	{
...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Índice Fórum</a> &gt; <a href="list_pm.php">Lista de Mensagens</a> &gt; Enviar Mensagem
    </div>
	<div class="box_right">
	...
	<h1>Nova mensagem pessoal</h1><br>
    <form action="new_pm.php" method="post">
		Por favor preencha o formulário abaixo para enviar sua mensagem:<br /><br>
        <label for="title">Assunto</label><input type="text" value="<?php echo htmlentities($otitle, ENT_QUOTES, 'UTF-8'); ?>" id="title" name="title" /><br />
        <label for="recip">Para<span class="small">(Username)</span></label><input type="text" value="<?php echo htmlentities($orecip, ENT_QUOTES, 'UTF-8'); ?>" id="recip" name="recip" /><br />
        <label for="message">Mensagem</label><textarea cols="40" rows="5" id="message" name="message"><?php echo htmlentities($omessage, ENT_QUOTES, 'UTF-8'); ?></textarea><br />
