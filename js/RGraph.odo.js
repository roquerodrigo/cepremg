    ...
    */
    RGraph.Odometer = function (id, start, end, value, value2)
    {
        this.id                = id
    ...
    RGraph.Odometer.prototype.DrawLabels = function ()
    {
        ...
        */
        if (this.Get('chart.value.text')) {
            ...
            RGraph.Text(context, font, size + 2, centerx, centery + size + 2 + 10, String(this.Get('chart.value.units.pre') + this.value2 + this.Get('chart.value.units.post')), 'center', 'center', true,  null, 'white');
        }
    }
